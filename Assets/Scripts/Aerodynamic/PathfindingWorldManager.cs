...
public class PathfindingWorldManager : MonoBehaviour
{
    public static PathfindingWorldManager Instance { get; private set; }
    ...
    {
        return transform.position.y + GridHeight * PointDistance / 2f;
    }
    ...
    public void InitializeGrid()
    {
        ...
        //                 Instantiate(prefab, Grid[i][j][k].WorldPosition, Quaternion.identity);
